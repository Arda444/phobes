...
class PhobesFeatureTreeScreen extends StatelessWidget {
  final bool embedded;
  const PhobesFeatureTreeScreen({super.key, this.embedded = false});
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> categories = [
      ...
      {
        'title': l10n.catNotesKnowledge,
        'icon': Icons.note_alt_rounded,
        'color': Colors.blue,
        'description': l10n.catNotesKnowledgeDesc,
        'sections': [
          {
            'name': l10n.secRichEditor,
            'features': [
              {
                'n': l10n.featNotePages,
                'd': l10n.featNotePagesDesc,
                'i': Icons.article_rounded,
              },
              {
                'n': l10n.featNoteEmbeds,
                'd': l10n.featNoteEmbedsDesc,
                'i': Icons.table_chart_rounded,
              },
              {
                'n': l10n.moduleInfoNotesTitle,
                'd': l10n.moduleInfoNotesIntro,
                'i': Icons.folder_special_rounded,
              },
            ],
          },
        ],
      ...
      {
        'title': l10n.catBooksReading,
        'icon': Icons.menu_book_rounded,
        'color': Colors.amber,
        'description': l10n.catBooksReadingDesc,
        'sections': [
          {
            'name': l10n.secReadingLife,
            'features': [
              {
                'n': l10n.featBookShelves,
                'd': l10n.featBookShelvesDesc,
                'i': Icons.library_books_rounded,
              },
              {
                'n': l10n.featBookQuotes,
                'd': l10n.featBookQuotesDesc,
                'i': Icons.format_quote_rounded,
              },
              {
                'n': l10n.moduleInfoBooksTitle,
                'd': l10n.moduleInfoBooksIntro,
                'i': Icons.auto_stories_rounded,
              },
            ],
          },
        ],
      ...
      {
        'title': l10n.catCorkboardPlanning,
        'icon': Icons.dashboard_customize_rounded,
        'color': Colors.indigo,
        'description': l10n.catCorkboardPlanningDesc,
        'sections': [
          {
            'name': l10n.secVisualPlanning,
            'features': [
              {
                'n': l10n.featCorkboardCards,
                'd': l10n.featCorkboardCardsDesc,
                'i': Icons.sticky_note_2_rounded,
              },
              {
                'n': l10n.featCorkboardLinks,
                'd': l10n.featCorkboardLinksDesc,
                'i': Icons.link_rounded,
              },
              {
                'n': l10n.moduleInfoCorkboardTitle,
                'd': l10n.moduleInfoCorkboardIntro,
                'i': Icons.hub_outlined,
              },
            ],
          },
        ],
      ...
      {
        'title': l10n.catProjectsTeams,
        'icon': Icons.groups_2_rounded,
        'color': Colors.pink,
        'description': l10n.catProjectsTeamsDesc,
        'sections': [
          {
            'name': l10n.secTeamDelivery,
            'features': [
              {
                'n': l10n.featTeamProjects,
                'd': l10n.featTeamProjectsDesc,
                'i': Icons.folder_copy_rounded,
              },
              {
                'n': l10n.featTeamKanbanDelivery,
                'd': l10n.featTeamKanbanDeliveryDesc,
                'i': Icons.view_kanban_rounded,
              },
              {
                'n': l10n.navTeams,
                'd': l10n.moduleInfoTeamsIntro,
                'i': Icons.group_rounded,
              },
            ],
          },
        ],
      ...
      {
        'title': l10n.catCalendarPlanning,
        'icon': Icons.calendar_month_rounded,
        'color': Colors.deepOrange,
        'description': l10n.catCalendarPlanningDesc,
        'sections': [
          {
            'name': l10n.secUnifiedCalendar,
            'features': [
              {
                'n': l10n.featCalendarMerge,
                'd': l10n.featCalendarMergeDesc,
                'i': Icons.calendar_view_month_rounded,
              },
              {
                'n': l10n.featUpcomingTimeline,
                'd': l10n.featUpcomingTimelineDesc,
                'i': Icons.upcoming_rounded,
              },
              {
                'n': l10n.navStatistics,
                'd': l10n.moduleInfoStatsIntro,
                'i': Icons.insights_rounded,
              },
            ],
          },
        ],
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ...categories.map((cat) => _buildImmersiveCategory(cat, cs, isWeb)),
